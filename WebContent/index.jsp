			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductList }" var="hotPro">
							<div class="col-md-2" style="text-align:center;height:200px;padding:10px 30px;">
									<a href="product_info.htm">
											<img src="${pageContext.request.contextPath }/${hotPro.pimage }" width="130" height="130" style="display: inline-block;">
									</a>
									<a href="product_info.html" style='color:#666'>${hotPro.pname }</a><br>
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProductList }" var="newPro">
								<div class="col-md-2" style="text-align:center;height:200px;padding:10px 30px;">
										...
										<a href="product_info.html" style='color:#666'>${newPro.pname }</a><br>
