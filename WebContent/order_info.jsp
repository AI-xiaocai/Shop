...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="confirmOrderForm" method="post" class="form-horizontal" style="margin-top: 5px; margin-left: 150px;"
						action="${pageContext.request.contextPath }/confirmOrder?oid="+${order.oid } >
