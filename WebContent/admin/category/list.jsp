...
<script type="text/javascript">
			...
			function delCategory(cid) {
				...
				if(isDel){
						window.location.href = "${pageContext.request.contextPath}/delCategoryAdmin?cid="+cid;
				}
			}
</script>
</HEAD>
					...
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<c:forEach items="${categoryList }" var="category" varStatus="vs">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<a href="${pageContext.request.contextPath}/updateCategoryAdminUI?cid=${category.cid}">
										<img src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand">
								</a></td>

								<td align="center" style="HEIGHT: 22px">
									<a href="javascript:java(0);" onclick="delCategory('${category.cid}')"> 
