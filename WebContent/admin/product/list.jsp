...
<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/addGoodAdminUI";
			}
			function delProduct(pid) {
				var isDel = confirm("确定删除该数据吗？");
				if(isDel){
						window.location.href = "${pageContext.request.contextPath}/delGoodAdmin?pid="+pid;
				}
			}
</script>
</HEAD>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${productList }" var="pro" varStatus="vs">
									<tr onmouseover="this.style.backgroundColor = 'white'"
										...
										<a href="${pageContext.request.contextPath}/updateGoodAdminUI?pid=${pro.pid}">
												<img src="${pageContext.request.contextPath}/images/i_edit.gif"
												border="0" style="CURSOR: hand"></a>
										</td>

										<td align="center" style="HEIGHT: 22px">
												<a href="javascript:java(0);" onclick="delProduct('${pro.pid}')"> 
