...
<script type="text/javascript">
		window.onload = function(){
			var yzmImg = document.getElementById("yzm");
			yzmImg.onclick=function(){
				this.src = "/Shop/yzm?loginTime=" + new Date().getTime();
			}
		}
	...
	$.validator.addMethod(
			"checkUsername",  //规则名称
			function(value,element, param){ //校验函数
					var flag = false;
					$.ajax({
						"async":false,
	...
	<div class="container" style="width: 100%; background: url('image/regist_bg.jpg');">
		<div class="row">
			...
			<div class="col-md-8" style="background: #fff; padding: 40px 80px; margin: 30px; border: 7px solid #ccc;">
				...
				<form id="registForm" class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath }/regist" method="post">
