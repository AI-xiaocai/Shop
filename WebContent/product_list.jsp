...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${pageBean.list }" var="pro">
				<div class="col-md-2" style="text-align:center; height:250px">
						...
						<a href="${pageContext.request.contextPath }/productInfo?pid=${pro.pid}&cid=${cid}&currentPage=${pageBean.currentPage}" style='color: green'>${pro.pname }</a><br>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pageBean.currentPage!=1 }">
					<li>
						<a href="${pageContext.request.contextPath }/productList?cid=${cid}&currentPage=${pageBean.currentPage-1}" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
			</c:if>
			...
			<c:forEach begin="1" end="${pageBean.totalPage }" var="page">
					...
					<c:if test="${pageBean.currentPage!=page }">
							<li><a href="${pageContext.request.contextPath }/productList?cid=${cid}&currentPage=${page}">${page }</a></li>
					</c:if>
			</c:forEach>
			...
			<c:if test="${pageBean.currentPage!=pageBean.totalPage }">
					<li>
							<a href="${pageContext.request.contextPath }/productList?cid=${cid}&currentPage=${pageBean.currentPage+1}" aria-label="Next"> 
